...
> (I made this tool! You can [try it here](https://opendi-org.github.io/cdd-authoring-tool/), in your browser.)
...
This is not necessarily the same as a [Goal](https://opendi.org/glossary#goal), since Outcomes generally don't judge the success or failure of the decision.
...
To discover _downstream_ Intermediates, ask ["Why?"](https://opendi.org/glossary#why-chain). To discover _upstream_ Intermediates, ask ["How?"](https://opendi.org/glossary#how-chain).  
...
Over the past year I've built a [browser-based engine](https://opendi-org.github.io/cdd-authoring-tool/) for displaying and authoring interactive decision models, and designed [data schemas](https://github.com/opendi-org/cdm-json-schema) for representing decisions, [transmitting](https://github.com/opendi-org/example-api-go) them, and using them in the engine. I have a lot to talk about!
